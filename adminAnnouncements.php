        ...
        <div class="row">
            ...
            <div class="col-9 padding-0 mt-5">
                ...
                while($row = $result->fetch_assoc()) {
                    echo '
                    <div class="alert alert-info" role="alert">'.$row['detail'].'<span class="float-right mr-5 font-weight-bold">Announcement Date: '.$row['date'].'<a class="btn btn-danger ml-5" href="controlPHP/adminDeleteAnnouncementControl.php?id='.$row['id'].'">Delete</a>'.'</span>'.'</div>
